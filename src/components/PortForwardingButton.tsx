...
import { faDotCircle, faQuestionCircle } from "@fortawesome/free-regular-svg-icons";
...
export default (props: PortForwardingButtonProps) => {
    ...
    const buttonClass = `${styles.switch} ${(() => { switch (conn.state) {
        case('unknown'):
        case('inactive'): return styles.switchInactive;
        case('pending'): return styles.switchPending;
        case('active'): return styles.switchActive;
    }})()}`;
    return (
      <span>
